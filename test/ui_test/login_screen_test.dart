...
void main() {
  ...
  //Need P'Ann Assist - Event we mock userService but it will go through real code T^T
  // testWidgets('Valid PIN and successful API call with dialog',
  //     (WidgetTester tester) async {
  //   // Mock user service responses
  //   when(mockUserService.fetchUserDetails2('132495')).thenAnswer((_) async => null);
  ...
  //   //Need P'Ann Assist 
  //   expect(find.byType(AlertDialog), findsOneWidget); //Currently after BE validated PIN success -> we display the alert popup - need to be fix
  //   expect(find.text('Invalid pin or network issue. please try again.'), findsOneWidget);
